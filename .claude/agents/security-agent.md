...
- `controllers/publishingstrategy/*_secret.go` (secret handling)
...
Example: [HIGH] [SECRET] pkg/cloudclient/aws/aws.go:42: Hardcoded API key detected
...
- **Prek hooks**: gitleaks runs automatically
